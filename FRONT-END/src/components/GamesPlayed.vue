          ...
          for (var x in this.games) {
            if (
              ...
              if (this.games[x].score_team1 > this.games[x].score_team2) {
                ...
                this.games[x].score_team1 < this.games[x].score_team2
              ) {
                losses++
              } else {
                draws++
              ...
              this.games[x].id_team2 === this.$store.getters.getTeamDetail.id
            ) {
              if (this.games[x].score_team2 > this.games[x].score_team1) {
                wins++
              } else if (
                this.games[x].score_team2 < this.games[x].score_team1
              ) {
                losses++
              } else {
                draws++
